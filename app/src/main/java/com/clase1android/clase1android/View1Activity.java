    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_notification.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(View1Activity.this,View1Activity.class);
                PendingIntent pendingIntent = PendingIntent.getActivity(View1Activity.this,0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
